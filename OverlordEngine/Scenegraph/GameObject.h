...
public:
	...
	typedef std::function<void(GameObject* colliderobject, GameObject* otherobject)> ColliderCallback;
	...
	void OnCollision(GameObject* colliderobject, GameObject* otherobject);
	...
	void SetOnColliderCallBack(ColliderCallback callback);
...
private:
	...
	void RootDraw_ShadowMap(const GameContext& gameContext);
	...
	ColliderCallback m_OnColliderCallback;
	wstring m_Tag;
